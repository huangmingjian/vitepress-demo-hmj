import{_ as a,c as i,o as n,ae as e}from"./chunks/framework.CEJdHl6x.js";const l="/vitepress-demo-hmj/assets/config1.yzFOimqt.jpg",t="/vitepress-demo-hmj/assets/config2.CpMk7AhA.jpg",g=JSON.parse('{"title":"导航栏配置","description":"","frontmatter":{},"headers":[],"relativePath":"linklocation/sidebar.md","filePath":"linklocation/sidebar.md"}'),p={name:"linklocation/sidebar.md"};function h(E,s,k,r,d,c){return n(),i("div",null,s[0]||(s[0]=[e(`<h1 id="导航栏配置" tabindex="-1">导航栏配置 <a class="header-anchor" href="#导航栏配置" aria-label="Permalink to &quot;导航栏配置&quot;">​</a></h1><h2 id="_1-1、默认配置" tabindex="-1">1.1、默认配置 <a class="header-anchor" href="#_1-1、默认配置" aria-label="Permalink to &quot;1.1、默认配置&quot;">​</a></h2><p>需要配置 config.mts 文件下的themeConfig.sidebar，如下代码所示:</p><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">sidebar: [</span></span>
